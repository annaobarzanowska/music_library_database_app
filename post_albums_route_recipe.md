...
POST /album?title=Voyage&release_year=2022&artist_id=2
...
describe Application do
  ...
  context "POST /albums" do
    it "creates an album named Voyage, release year 2022 and artist id 2" do
        ...
        expect(response_get.body).to eq 'Doolittle, Surfer Rosa, Waterloo, Super Trouper, Bossanova, Lover, Folklore, I Put a Spell on You, Baltimore, Here Comes the Sun, Fodder on My Wings, Ring Ring, Voyage'
